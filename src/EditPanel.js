...
const EditPanel = ({
  ...
  const handleAddExistingPerson = (personId) => {
    if (addingRelation === "parent") {
      ...
      const parentType =
        parentNode && parentNode.gender === "F" ? "WIFE" : "HUSB";
  ...
  return (
    <div className="edit-panel" style={panelStyle}>
      <div style={{ padding: "1rem" }}>
            ...
            <div>
              ...
              >
                ...
                <button
                  ...
                  onClick={() => removeNodePhoto(node.id)}
                >
                  Remove
                </button>
              </div>
        ...
        {/* Save button */}
        <button
          style={{ ...btnPrimaryStyle, width: "100%", marginBottom: "0.5rem" }}
          onClick={handleSave}
        >
          Save Changes
        </button>
        ...
        <div>
          {relationships.parents.map((rel) => (
            <span
              key={rel.node.id}
              style={{ ...chipStyle, background: rel.node.color }}
            >
          ...
          <button
            style={{ ...btnStyle, marginLeft: "0.5rem", fontSize: "0.8rem" }}
            onClick={() => {
              setAddingRelation("parent");
              setShowNewPersonForm(false);
              setSearchQuery("");
            }}
          >
        ...
        {addingRelation && (
          ...
          >
            ...
            <div style={{ marginTop: "0.5rem" }}>
              {!showNewPersonForm ? (
                <button
                  style={{ ...btnStyle, width: "100%", fontSize: "0.8rem" }}
                ...
                >
                  ...
                  <input
                    ...
                    value={newPerson.yob}
                    onChange={(e) =>
                      setNewPerson({ ...newPerson, yob: e.target.value })
                    }
                  />
                  <button
        ...
        <div
          style={{
            marginTop: "2rem",
            borderTop: "1px solid var(--grey-light-soft)",
            paddingTop: "1rem",
          }}
        >
          {!showDeleteConfirm ? (
            <button
              style={{ ...btnDangerStyle, width: "100%" }}
